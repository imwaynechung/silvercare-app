...
const Testimonials: React.FC = () => {
  const testimonials = [
    {
      quote: "跌倒一次，真係會改變一世。我而家每日用銀齡樂運動 10 分鐘，上落樓梯唔再驚。",
      name: "Margaret",
      role: "72 歲用戶",
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="flex flex-col h-full">
                <div className="mb-4">
                  <svg className="w-8 h-8" style={{ color: '#08449E' }} fill="currentColor" viewBox="0 0 24 24">
